    ...
    class TaxonsController < Spree::Admin::BaseController
      ...
      def create
        ...
        if @taxon.save
          ...
          respond_with(@taxon) do |format|
            format.html { redirect_to @taxonomy ? edit_admin_category_url(@taxonomy) : admin_categories_url }
          end
        end
      end

      def edit
        @taxonomy = Taxonomy.find(params[:category_id])
      ...
      def update
        ...
        respond_with(@taxon) do |format|
          format.html { redirect_to edit_admin_category_url(@taxonomy) }
        end
      end
