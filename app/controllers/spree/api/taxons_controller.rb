  ...
  module Api
    class TaxonsController < Spree::Api::BaseController
      ...
      def create
        ...
        @taxon.taxonomy_id = params[:category_id]
        taxonomy = Spree::Taxonomy.find_by(id: params[:category_id])
      ...
      def taxonomy
        if params[:category_id].present?
          @taxonomy ||= Spree::Taxonomy.accessible_by(current_ability, :read).find(params[:category_id])
        end
      end
