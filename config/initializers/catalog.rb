class Spree::Catalog < Spree::Base

  self.table_name = 'spree_taxons'
  acts_as_nested_set dependent: :destroy

  belongs_to :categories, class_name: 'Spree::Category', :foreign_key=>'taxonomy_id'
  has_many :classifications, -> { order(:position) }, dependent: :delete_all, inverse_of: :taxons
